	...
	<div class="container">
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				<li <?=$controller=='courses' ? 'class="active"' : ''?>><a href="courses">Ained</a></li>
				<li <?=$controller=='foo' ? 'class="active"' : ''?>><a href="foo">Foo</a></li>
				<li <?=$controller=='bar' ? 'class="active"' : ''?>><a href="bar">Bar</a></li>
				<li class="dropdown">
